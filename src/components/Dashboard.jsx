...
const Dashboard = () => {
    ...
    const handleCreatePost = async () => {
        ...
        const newPost = await postsAPI.addPost({ content: newPostContent, contentType: newPostImage ? 'image' : 'text', postType: 'post' })
    ...
    const handleLikePost = async (postId, contentType) => {
        const response = await postsAPI.reactOnPostOrComment(postId, 'like');
        if (response) {
    ...
    const handleAddComment = async (postId) => {
        ...
        const comment = await postsAPI.addComment(postId, commentText);
        setPosts(posts.map(post => {
            if (post.id === postId) {
                return {
                    ...post,
                    comments: [comment?.data?.comment, ...post.comments]
                };
            }
            return post;
        }));
                            ...
                            <div className="col-lg-8">
                                ...
                                <div className="create-post">
                                    <div className="d-flex align-items-center mb-3">
                                        <img src={'/default-profile.jpeg'} alt="Profile" className="rounded-circle me-3" width={50} height={50} />
                                        <input
                                            type="text"
                                ...
                                {posts.map(post => (
                                    <div key={post.id} className="card post-card">
                                        <div className="card-body">
                                            <div className="d-flex align-items-center mb-3">
                                                <img src={post.userAvatar ?? '/default-profile.jpeg'} alt="Profile" className="rounded-circle me-3" width={50} height={50} />
                                                <div>
                                            ...
                                            <div className="comments-section">
                                                {post?.comments?.map(comment => (
                                                    <div key={comment.id} className="mb-3">
                                                        <div className="d-flex mb-2">
                                                            <img src={comment.userAvatar ?? '/default-profile.jpeg'} alt="User" className="rounded-circle me-2" width={35} height={35} />
                                                        ...
                                                        {comment?.replies?.map(reply => (
                                                            <div key={reply.id} className="d-flex mb-2 ms-4">
                                                                <img src={reply.userAvatar ?? '/default-profile.jpeg'} alt="User" className="rounded-circle me-2" width={30} height={30} />
                                                                <div className="bg-light rounded p-2 flex-grow-1">
                                                                    <div className="d-flex justify-content-between align-items-start">
                                                                        <div>
                                                        ...
                                                        <div
                                                            ...
                                                            style={{ display: 'none' }}
                                                        >
                                                            <img src={'/default-profile.jpeg'} alt="Profile" className="rounded-circle me-2" width={30} height={30} />
                                                            <input
                                                                type="text"
                                                ...
                                                {/* Add Comment Input */}
                                                <div className="d-flex">
                                                    <img src={'/default-profile.jpeg'} alt="Profile" className="rounded-circle me-2" width={35} height={35} />
                                                    <input
                                                        type="text"
