                ...
                <div className="col-lg-8">
                  ...
                  <div className="create-post">
                    <div className="d-flex align-items-center mb-3">
                      ...
                      <input type="text" className="form-control" placeholder="What's on your mind, Sarah?" style={{borderRadius: '25px'}} />
                    </div>
                      ...
                      <div className="comments-section">
                        <div className="d-flex mb-3">
                          ...
                          <div className="bg-light rounded p-2 flex-grow-1">
                            <strong>Mike Chen</strong> <small className="text-muted">1h</small><br />
                            <span>Wow! Where is this exactly? Looks incredible! 😍</span>
                          </div>
                        </div>
                        <div className="d-flex">
                          ...
                          <input type="text" className="form-control" placeholder="Write a comment..." style={{borderRadius: '20px'}} />
                        </div>
                      </div>
                    </div>
                  </div>
